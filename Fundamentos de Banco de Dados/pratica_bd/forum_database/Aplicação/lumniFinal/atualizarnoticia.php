...
<head>
  ...
  <link rel="stylesheet" href="css/conteudoVerticalMenu.css">
...
<body> 
  <nav>
    ...
    <ul>
        <li class="nav-link"><a href="index.php">INÍCIO</a></li>
        <li class="nav-link"><a href="#">FÓRUM</a></li>
        <li class="nav-link"><a href="#">LOJA</a></li>
        <li class="nav-link"><a href="#">EVENTOS</a></li>
        <li class="nav-link"><a href="#">RELATOS</a></li>
        ...
        <li id="loja" class="secundary-menu"><button><i class="icon-C sub-menu"><sup>0</sup></i></li>
        <div class="dropdown">
  ...
  <section class="containerProfile">
      <div class="aside-menu">
          <ul>
              <li><a href="profile.html"><i class="icon-U"></i><p>MEU PERFIL</p></a></li>
              <li><a href="profilenoticia.php" class="marcado"><i class="icon-1"></i><p class="marcado" style="color: rgb(113, 32, 115);">NOTÍCIAS</p></a></li>
              <li><a href="#"><i class="icon-C"></i><p>PRODUTOS</p></a></li>
              <li><a href="#"><i class="icon-11"></i><p>MODERADORES</p></a></li>
              <li><a href="#"><i class="icon-10"></i><p>COLABORADORES</p></a></li>
              <li><a href="#"><i class="icon-13"></i><p>EVENTOS</p></a></li>
              <li><a href="#"><i class="icon-P"></i><p>PROBLEMAS RELATADOS</p></a></li>
              <li><a href="#"><i class="icon-7"></i><p>LIXEIRA</p></a></li>
          </ul>
      </div>
      <div class="formNoticia">
        <h1>ATUALIZAÇÃO DE NOTÍCIA</h1>
        <form action="atualizarnoticia.php?id=<?php echo $noticia['id']; ?>" method="post">
        <input type="text" placeholder="Título" name="noticia['titulo']" value="<?php echo $noticia['titulo'] ?>"><br>
        <input type="text" placeholder="Autor" name="noticia['autor']"value="<?php echo $noticia['autor'] ?>"><br>
        <input type="date" placeholder="Data" name="noticia['data']" value="<?php echo $noticia['data'] ?>"><br>
        <input type="time" placeholder="Horário" name="noticia['horario']" value="<?php echo $noticia['horario'] ?>"><br>
        <textarea style ="resize:none;" cols="10" rows="10" name="noticia['texto']" ><?php echo $noticia['texto'] ?></textarea><br>
...
<footer>
  ...
  <br>
  <p id="copy">© 2020 By Portal Lumni, Todos os direitos reservados</p>
</footer>
