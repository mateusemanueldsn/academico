...
<body> 
  ...
  <section class="containerProfile">
      ...
      <div class="formNoticia">
        ...
        <form action="cadnoticia.php" method="post">
            <input type="text" placeholder="Título" name="noticia['titulo']"><br>
            <input type="text" placeholder="Autor" name="noticia['autor']"><br>
            <input type="date" placeholder="Data" name="noticia['data']"><br>
            <input type="time" placeholder="Horário" name="noticia['horario']"><br>
            <textarea cols="10" rows="10" placeholder="Texto da Publicação" name="noticia['texto']"></textarea><br>
