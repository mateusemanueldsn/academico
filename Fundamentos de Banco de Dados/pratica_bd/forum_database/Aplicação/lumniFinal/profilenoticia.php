...
<body> 
  ...
  <section class="containerProfile">
      ...
      <div class="perfilconteudoVerticalMenu">
          <div class="opcoesNoticia">
            <form class="openBtn" action="" onclick="openSearch();">
              <input type="search" placeholder="Buscar notícia" name="busca">
              <button type="submit"><i class="icon-B" id="lupa"></i></button>
            </form>
            <button id="newN"><a href="cadnoticias.html">Cadastrar nova notícia</a></button>
          </div>
            ...
            <?php if ($noticias) : ?>
              <?php foreach ($noticias as $noticia) : ?>	
                ...
                <h2><?php echo $noticia['titulo']; ?></h2> 
                  <div>
                  <button><a href="atualizarnoticia.php?id=<?php echo $noticia['id']; ?>">Alterar dados</a></button>
                  <a href="viewnoticia.php?id=<?php echo $noticia['id']; ?>"><i class="icon-5" style="font-size:2em"></i></a>
                  <a href="delete.php?id=<?php echo $noticia['id']; ?>"><i class="icon-7"style="font-size:2em"></i></a>
                  </div>
                </li>
                <?php 
                  endforeach;
