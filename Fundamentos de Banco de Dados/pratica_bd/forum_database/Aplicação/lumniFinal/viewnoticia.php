...
<body> 
  ...
  <section class="containerProfile">
      <div class="aside-menu">
        ...
        <div class="perfilconteudoVerticalMenuView">
            <h2><?php echo $noticia['titulo']; ?></h2>
            <legend>Postado por <?php echo $noticia['autor']; ?></legend>
            <legend>Publicado em <?php echo $noticia['data']; ?> as <?php echo $noticia['horario']; ?></legend>
            <p><?php echo $noticia['texto']; ?></p>
            <button><a href="profilenoticia.php">Voltar</a></button>
        </div>     
  </section>
  <footer>
    <ul class="social">
